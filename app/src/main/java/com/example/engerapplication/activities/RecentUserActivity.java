...
import com.example.engerapplication.databinding.ActivityRecentUserBinding;
...
public class RecentUserActivity extends AppCompatActivity {

    private ActivityRecentUserBinding binding;
    private PreferenceManager preferenceManager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding =  ActivityRecentUserBinding.inflate(getLayoutInflater());
